...
export const TeacherStyle = StyleSheet.create({
  ...
  avatar: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#34C75915', justifyContent: 'center', alignItems: 'center' },
  avatarText: { color: '#34C759', fontWeight: 'bold' },
  info: { flex: 1, marginLeft: 12 },
  name: { fontSize: 16, fontWeight: '700' },
  details: { fontSize: 13, color: '#8E8E93' },
  experienceText: { fontSize: 12, color: '#007AFF', fontWeight: '600', marginTop: 2 },
  tag: { backgroundColor: '#F2F2F7', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, alignSelf: 'flex-start', marginTop: 6 },
  tagText: { fontSize: 11, color: '#3A3A3C', fontWeight: '600' },
